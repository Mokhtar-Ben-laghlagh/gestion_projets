...
public class LivrableServiceImpl implements LivrableService {
    ...
    @Transactional(readOnly=true) public List<LivrableResponse> getByPhase(Long pId) { return repo.findByPhaseId(pId).stream().map(this::toResp).collect(Collectors.toList()); }
